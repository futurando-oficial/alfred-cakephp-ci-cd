...
<div class="row">
    ...
    <div class="col-6 text-right">
        <a href="<?= $this->Url->build(['controller' => 'Projects', 'action' => 'sources']) ?>" class="btn btn-primary">New Project</a>
    </div>
</div>
...
<?php else : ?>
    ...
    <div class="row">
        <div class="col-12 text-center">
            <a href="<?= $this->Url->build(['controller' => 'Projects', 'action' => 'sources']); ?>" class="btn btn-primary">Create</a>
        </div>
    </div>
<?php endif; ?>