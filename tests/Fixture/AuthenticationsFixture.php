...
class AuthenticationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'service' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 'f028a5a2-aac4-4664-a8fb-c736021deef3',
                'user_id' => '76ff51b4-6aaf-46f1-8713-7bee1a97ac2b',
                'service' => 1,
                'token' => 'Lorem ipsum dolor sit amet',
                'expiration' => '2019-10-28 02:27:37',
                'status' => 1,
                'created' => '2019-10-28 02:27:37',
                'modified' => '2019-10-28 02:27:37'
            ],
        ];
        parent::init();
    }
